"""
FIFA World Cup 2002 ETL Pipeline
Standalone script — reads the 2002 teams.csv and results.csv from the
...
# --- CONFIG ---
TEAMS_CSV_PATH = "2002/teams.csv"
RESULTS_CSV_PATH = "2002/results.csv"
...
def load_to_sqlite(clean_teams, clean_matches, db_name=DB_NAME):
    ...
    connection.commit()
    connection.close()
    print(f"2002 data loaded into SQLite successfully! Database file: {db_name}")
