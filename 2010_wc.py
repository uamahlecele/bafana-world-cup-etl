"""
FIFA World Cup 2010 ETL Pipeline
Standalone script — reads the 2010 teams.csv and results.csv from the
...
# --- CONFIG ---
TEAMS_CSV_PATH = "2010/teams.csv"
RESULTS_CSV_PATH = "2010/results.csv"
...
def load_to_sqlite(clean_teams, clean_matches, db_name=DB_NAME):
    ...
    connection.commit()
    connection.close()
    print(f"2010 data loaded into SQLite successfully! Database file: {db_name}")
